...
%token  AMPERSAND ASTERISK
        CIRCUMFLEX COLON COMMA
        DOLLAR_SIGN
        DOUBLE_QUOTE
        EQUALS_OPERATOR EXCLAMATION_MARK
        GRAVE_ACCENT LEFT_BRACE LEFT_BRACKET LEFT_PAREN LEFT_ANGLE_BRACKET
        MINUS_SIGN
        PERCENT PERIOD
        PLUS_SIGN
        QUESTION_MARK QUOTE
        REVERSE_SOLIDUS RIGHT_ANGLE_BRACKET RIGHT_BRACE RIGHT_BRACKET RIGHT_PAREN
        SEMICOLON SOLIDUS SPACE
        TILDE
        UNDERSCORE
        VERTICAL_BAR
...
%token  BRACKET_RIGHT_ARROW BRACKET_TILDE_RIGHT_ARROW
        CONCATENATION_OPERATOR DOUBLE_COLON DOUBLE_MINUS_SIGN DOUBLE_PERIOD DOUBLE_SOLIDUS
